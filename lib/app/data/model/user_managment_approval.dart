...
//
//     final userManagementApprove = userManagementApproveFromJson(jsonString);

import 'dart:convert';

List<UserManagementApprove> userManagementApproveFromJson(String str) =>
    List<UserManagementApprove>.from(
        json.decode(str).map((x) => UserManagementApprove.fromJson(x)));

String userManagementApproveToJson(List<UserManagementApprove> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class UserManagementApprove {
  ...
  factory UserManagementApprove.fromJson(Map<String, dynamic> json) =>
      UserManagementApprove(
        type: json["type"],
        id: json["id"],
...
class Relationships {
  ...
  BusinessSegment jabatan;
  BusinessSegment coreUser;
  BusinessSegment profilePicture;

  factory Relationships.fromJson(Map<String, dynamic> json) => Relationships(
        businessSegment: BusinessSegment.fromJson(json["business-segment"]),
        jabatan: BusinessSegment.fromJson(json["jabatan"]),
        coreUser: BusinessSegment.fromJson(json["core-user"]),
        profilePicture: BusinessSegment.fromJson(json["profile-picture"]),
      );

  Map<String, dynamic> toJson() => {
        "business-segment": businessSegment.toJson(),
        "jabatan": jabatan.toJson(),
        "core-user": coreUser.toJson(),
        "profile-picture": profilePicture.toJson(),
      };
}
