...
List<UserManagement> userManagementFromJson(String str) =>
    List<UserManagement>.from(
        json.decode(str).map((x) => UserManagement.fromJson(x)));

String userManagementToJson(List<UserManagement> data) =>
