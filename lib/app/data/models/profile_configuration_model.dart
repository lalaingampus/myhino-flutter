...
class Attributes {
  Attributes({
    required this.aboutUsImagesId,
    required this.aboutUsImagesOriginalFileName,
    required this.aboutUsAttachment,
    ...
    required this.telematicImagesId,
    required this.telematicImagesOriginalFileName,
    required this.telematicUrl,
    required this.telematicContent,
    this.createdBy,
