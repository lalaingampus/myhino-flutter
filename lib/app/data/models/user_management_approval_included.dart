...
//
//     final userApprovalInclude = userApprovalIncludeFromJson(jsonString);

import 'dart:convert';

UserApprovalInclude userApprovalIncludeFromJson(String str) =>
    UserApprovalInclude.fromJson(json.decode(str));

String userApprovalIncludeToJson(UserApprovalInclude data) =>
    json.encode(data.toJson());

class UserApprovalInclude {
  UserApprovalInclude({
    required this.type,
    required this.id,
  ...
  factory UserApprovalInclude.fromJson(Map<String, dynamic> json) =>
      UserApprovalInclude(
        type: json["type"],
        id: json["id"],
